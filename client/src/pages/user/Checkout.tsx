...
const Checkout = () => {
  ...
  // ==========================================
  // FIX: also grab `loading` from useCart().
  // Without this, the page decides the cart is
  // empty before the async fetch on mount has
  // finished, showing "Your cart is empty" even
  // when the cart genuinely has items.
  // ==========================================
  ...
  // =====================================================
  // STILL LOADING THE CART
  // (Fix: wait for the async cart fetch to finish before
  // deciding whether the cart is actually empty.)
  // =====================================================
 
  if (cartLoading) {
    return (
      <section className="min-h-screen bg-[#F7F3EC] flex items-center justify-center">
        <div className="text-center">
 
          <div className="w-14 h-14 border-4 border-[#D8531F] border-t-transparent rounded-full animate-spin mx-auto" />
  ...
  // =====================================================
  // EMPTY CART
  // (Only shown now once the fetch has actually finished
  // AND the cart is genuinely empty.)
  // =====================================================
